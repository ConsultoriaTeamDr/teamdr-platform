        ...
        <div style={{...fade(0),position:"relative"}}>
          {onBack && (
            <button onClick={onBack} style={{background:"transparent",border:"none",
              color:G.muted,fontFamily:F.m,fontSize:"9px",letterSpacing:"2px",
              cursor:"pointer",marginBottom:"16px",padding:0,display:"block"}}>
              ← VOLTAR AO CATÁLOGO
            </button>
          )}
      ...
      <div style={{margin:"40px clamp(16px,4vw,60px)",borderRadius:"16px",overflow:"hidden",
        ...
        <div style={{flex:1,minWidth:"260px",padding:"32px 36px",display:"flex",flexDirection:"column",justifyContent:"center",position:"relative"}}>
          ...
          <div style={{position:"relative"}}>
            ...
            <p style={{fontFamily:F.s,fontSize:"14px",color:G.muted,lineHeight:1.85,maxWidth:"480px",margin:"0 0 20px"}}>
...
function ToolsPage({ user, onFilter }) {
  ...
  const gerarTreino = () => {
    ...
    const planos={
      ...
      "qualidade-3-academia":["Seg: Full Body leve + Mobilidade 15min","Qua: Cardio moderado 30min + Core","Sex: Full Body + Alongamento"],
      "qualidade-3-casa":["Seg: Circuito funcional suave 30min","Qua: Caminhada rápida 40min + Mobilidade","Sex: Yoga funcional + Força leve"],
      "qualidade-3-misto":["Seg: Full Body (academia) 45min","Qua: Caminhada/corrida leve ao ar livre","Sex: Mobilidade + Core em casa"],
      "qualidade-4-academia":["Seg: Membros superiores + Mobilidade","Ter: Cardio 30min + Core","Qui: Membros inferiores + Equilíbrio","Sex: Full Body leve + Alongamento"],
    };
            ...
            <>
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"0 20px"}}>
                <TSelect label="OBJETIVO" value={trForm.objetivo} onChange={e=>setTr("objetivo",e.target.value)}
                  options={[{v:"hipertrofia",l:"Hipertrofia — Ganhar massa"},{v:"emagrecimento",l:"Emagrecimento — Perder gordura"},{v:"forca",l:"Força — Levantamentos"},{v:"condicionamento",l:"Condicionamento — HIIT + Corrida"},{v:"qualidade",l:"Qualidade de Vida — Saúde e bem-estar"}]}/>
...
// ── ROOT ─────────────────────────────────────────────────────────────────────
// O funil público fica inline aqui como componente simplificado
// pra não precisar de import externo no preview
function PublicFunnel({ onLogin }) {
  return (
    <div style={{minHeight:"100vh",background:G.bg,fontFamily:F.s}}>
      <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,700;0,900;1,400&family=DM+Mono:wght@400;500&family=DM+Sans:wght@400;500;600&display=swap" rel="stylesheet"/>
      <style>{`*{box-sizing:border-box} ::-webkit-scrollbar{display:none}`}</style>

      {/* NAV com botão "Já sou cliente" */}
      <nav style={{padding:"0 clamp(16px,4vw,60px)",height:"62px",display:"flex",
        ...
        <button onClick={onLogin} style={{
          ...
          color:G.gold,fontFamily:F.m,fontSize:"10px",
      ...
      <div style={{position:"relative",overflow:"hidden"}}>
        ...
        <div style={{display:"flex",flexWrap:"wrap",alignItems:"stretch",minHeight:"520px",position:"relative"}}>
          <div style={{flex:"0 0 clamp(260px,36vw,400px)",position:"relative",overflow:"hidden"}}>
            <img src="/daniel.jpg" alt="Daniel Rezende"
              style={{width:"100%",height:"100%",objectFit:"cover",objectPosition:"center top",display:"block",minHeight:"520px"}}/>
            <div style={{position:"absolute",inset:0,background:"linear-gradient(to right,transparent 55%,rgba(8,8,8,0.98) 100%)"}}/>
          </div>

          <div style={{flex:1,minWidth:"300px",padding:"48px clamp(24px,4vw,56px)",
            display:"flex",flexDirection:"column",justifyContent:"center"}}>
            <div style={{fontFamily:F.m,fontSize:"9px",letterSpacing:"5px",color:G.gold,marginBottom:"14px"}}>
              DANIEL REZENDE · TEAMDR
            </div>
            <h1 style={{margin:"0 0 6px",fontFamily:F.d,fontSize:"clamp(36px,5vw,56px)",
              fontWeight:"900",color:G.white,lineHeight:0.9,letterSpacing:"-2px"}}>Transforme</h1>
            <h1 style={{margin:"0 0 20px",fontFamily:F.d,fontSize:"clamp(36px,5vw,56px)",
              fontWeight:"900",color:G.gold,lineHeight:0.9,letterSpacing:"-2px",fontStyle:"italic"}}>seu corpo.</h1>

            <div style={{borderLeft:`3px solid ${G.gold}`,paddingLeft:"16px",marginBottom:"18px"}}>
              <p style={{fontFamily:F.d,fontSize:"15px",fontStyle:"italic",color:G.white,lineHeight:1.5,margin:0}}>
                "Não importa se você nunca pisou numa academia ou se já treina há anos. Meu trabalho é te levar ao próximo nível."
              </p>
            </div>

            <p style={{fontFamily:F.s,fontSize:"14px",color:G.muted,lineHeight:1.85,margin:"0 0 24px",maxWidth:"460px"}}>
              Bacharel em Educação Física pela UERJ, pós graduado em Biomecânica e Cinesiologia, com Diploma internacional na área de Fitness Trainer. Atleta de fisiculturismo com mais de 10 anos competindo no Brasil e no exterior. Já ajudei mais de 1000 alunos em vários países.
            </p>

            <div style={{display:"flex",gap:"24px",flexWrap:"wrap"}}>
              {[["10+","anos competindo"],["1000+","alunos"],["NPC","campeão internacional"],["5+","anos consultoria"]].map(([n,l])=>(
                <div key={n}>
                  <div style={{fontFamily:F.m,fontSize:"18px",fontWeight:"500",color:G.gold,letterSpacing:"-0.5px"}}>{n}</div>
                  <div style={{fontFamily:F.s,fontSize:"11px",color:G.muted,marginTop:"2px"}}>{l}</div>
                </div>
      ...
      {/* Mensagem direcionamento */}
      <div style={{textAlign:"center",padding:"56px clamp(16px,4vw,60px) 48px"}}>
        <div style={{fontFamily:F.m,fontSize:"9px",letterSpacing:"5px",color:G.gold,marginBottom:"12px"}}>
          MONTE SEU PROGRAMA
        </div>
        <h2 style={{margin:"0 0 12px",fontFamily:F.d,fontSize:"clamp(24px,4vw,38px)",
          fontWeight:"700",color:G.white,letterSpacing:"-0.5px"}}>
          Por onde você quer começar?
        </h2>
        <p style={{fontFamily:F.s,fontSize:"15px",color:G.muted,maxWidth:"480px",
          margin:"0 auto 36px",lineHeight:1.75}}>
          Responda algumas perguntas rápidas e descubra o programa ideal para o seu objetivo. Começa pelo IMC — é gratuito.
        </p>

        <div style={{display:"flex",justifyContent:"center",gap:"16px",flexWrap:"wrap"}}>
          {[
            {icon:"◉",label:"Calcular IMC",sub:"Gratuito"},
            {icon:"▦",label:"Ver Treinos",sub:"A partir de R$77"},
            {icon:"◈",label:"Avaliação Postural",sub:"R$47"},
            {icon:"◆",label:"Planos de Dieta",sub:"A partir de R$47"},
          ].map((c,i)=>(
            <div key={i} style={{background:G.bg2,border:`1px solid ${G.faint}`,
              borderRadius:"12px",padding:"20px 24px",minWidth:"140px",textAlign:"center",
              cursor:"pointer",transition:"all 0.2s"}}
              onMouseEnter={e=>{e.currentTarget.style.borderColor=G.border;e.currentTarget.style.background="rgba(201,168,76,0.06)"}}
              onMouseLeave={e=>{e.currentTarget.style.borderColor="rgba(245,240,232,0.08)";e.currentTarget.style.background=G.bg2}}>
              <div style={{fontFamily:F.m,fontSize:"22px",color:G.gold,marginBottom:"8px"}}>{c.icon}</div>
              <div style={{fontFamily:F.s,fontSize:"13px",color:G.white,marginBottom:"4px"}}>{c.label}</div>
              <div style={{fontFamily:F.m,fontSize:"9px",color:G.muted,letterSpacing:"1px"}}>{c.sub}</div>
            </div>
          ))}
        </div>

        <p style={{fontFamily:F.s,fontSize:"12px",color:"rgba(245,240,232,0.25)",
          marginTop:"28px"}}>
          Acesse o funil completo em{" "}
          <a href="https://app.danirezendepersonal.com.br" style={{color:G.gold}}>
            app.danirezendepersonal.com.br
          </a>
        </p>
      </div>
    </div>
...
export default function App() {
  ...
  return <PublicFunnel onLogin={()=>setShowLogin(true)}/>;
}
